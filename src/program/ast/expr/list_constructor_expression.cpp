...
namespace avalon {
     ...
     */
    void list_constructor_expression::set_type_instance(type_instance& instance) {
        m_instance = instance;
    }
     ...
     */
    type_instance& list_constructor_expression::get_type_instance() {
        return m_instance;
    }
     ...
     */
    bool list_constructor_expression::has_type_instance() {
