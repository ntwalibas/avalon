#ifndef AVALON_MIR_AST_EXPR_DECIMAL_EXPRESSION_HPP_
#define AVALON_MIR_AST_EXPR_DECIMAL_EXPRESSION_HPP_
...
namespace avalon {
    class mir_decimal_expression : public mir_expr {
    public:
        /**
         * the constructor expects the token with type source information
         */
        mir_decimal_expression(token& tok, mir_type& l_type, const std::string& val);
        ...
        /**
         * is_decimal_expression
         * return true as objects of this class are decimal expressions
         */
