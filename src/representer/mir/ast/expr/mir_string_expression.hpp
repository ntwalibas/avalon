#ifndef AVALON_MIR_AST_EXPR_STRING_EXPRESSION_HPP_
#define AVALON_MIR_AST_EXPR_STRING_EXPRESSION_HPP_
...
namespace avalon {
    class mir_string_expression : public mir_expr {
    public:
        /**
         * the constructor expects the token with type source information
         */
        mir_string_expression(token& tok, mir_type& l_type, const std::string& val);
         ...
         * return true as objects of this class are string expressions
         */
